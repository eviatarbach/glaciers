...
# parameters
DSargs.pars = {'g': 1, 'P': 0, 'alpha': 4/5., 'beta': 7/5.}
...
PCargs.MaxNumPoints = 800                      # The following 3 parameters are set after trial-and-error
PCargs.MaxStepSize  = 2e-4
PCargs.MinStepSize  = 1e-5
PCargs.StepSize     = 2e-4
PCargs.SaveEigen    = True                     # to tell unstable from stable branches
...
plt.figure(3)
plt.plot([0.25, 0.4], [0, 0], 'black')
plt.xlabel('$P^*$', fontsize=16)
plt.ylabel('$V_s^*$', fontsize=16, rotation=0)
plt.title('')
ax = plt.gca()
